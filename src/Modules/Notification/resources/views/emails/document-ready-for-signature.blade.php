                        ...
                        <tr>
                            <td style="padding:36px 36px 28px;">
                                ...
                                <div style="text-align:center; margin:28px 0 16px;">
                                    <a href="{{ $portalUrl }}" style="display:inline-block; background-color:{{ $primaryColor ?? '#2563EB' }}; color:#ffffff; font-weight:700; font-size:15px; letter-spacing:-0.01em; text-decoration:none; padding:13px 32px; border-radius:8px; text-align:center;">
                                        Review &amp; Sign
                                    </a>
                                </div>
                                ...
                                <p style="font-size:11px; color:#94A3B8; text-align:center; margin-top:8px; word-break:break-all;">
                                    ...
                                    <a href="{{ $portalUrl }}" style="color:{{ $primaryColor ?? '#2563EB' }};">{{ $portalUrl }}</a>
                                </p>
