...
<head>
    ...
    <title>{{ $providerName }} invited you to your client portal</title>
</head>
<body style="margin:0; padding:40px 16px; background:#E4E7EE; font-family:'Inter',Arial,sans-serif;">

@php
    $accent = $primaryColor ?? '#1D4ED8';
    $initial = $providerInitial ?? strtoupper(substr($providerName ?? 'P', 0, 1));
@endphp
                    ...
                    <table cellpadding="0" cellspacing="0" width="100%">
                        <tr>
                            ...
                            <td style="text-align:right; vertical-align:middle;">
                                <span style="font-size:10px; font-weight:500; color:#94A3B8; letter-spacing:0.03em;">Secure client portal</span>
                            </td>
                        </tr>
                    </table>
                </td>
            ...
            <tr>
                <td style="padding:28px 20px;">
                    <table width="100%" cellpadding="0" cellspacing="0" style="background:#ffffff; border-radius:10px; border:1px solid #E2E8F0;">
                        <!-- Accent top bar using the provider's own color -->
                        <tr>
                        ...
                        <tr>
                            <td style="padding:32px 32px 28px;">
                                ...
                                <p style="font-size:11px; font-weight:700; color:#94A3B8; text-transform:uppercase; letter-spacing:0.07em; margin:0 0 8px;">Client Invitation</p>
                                <h1 style="font-size:20px; font-weight:700; color:#0F172A; letter-spacing:-0.02em; margin:0 0 10px; line-height:1.3;">
                                    @if(!empty($clientName)) You're invited, {{ $clientName }} @else {{ $providerName }} invited you to their client portal @endif
                                </h1>
                                <p style="font-size:14px; color:#334155; line-height:1.7; margin:0 0 20px; max-width:440px;">
                                    <strong style="color:#0F172A;">{{ $invitedByName }}</strong> at <strong style="color:#0F172A;">{{ $providerName }}</strong> has invited you to a secure portal where you can view documents, track progress, and sign agreements online — all in one place.
                                </p>
                                    ...
                                    <table width="100%" cellpadding="0" cellspacing="0">
                                        ...
                                        <tr>
                                            <td style="padding-top:10px;">
                                                <table width="100%" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        <td style="font-size:12px; color:#64748B; font-weight:500;">Firm</td>
