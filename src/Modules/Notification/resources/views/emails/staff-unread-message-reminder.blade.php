                                    ...
                                    <table width="100%" cellpadding="0" cellspacing="0">
                                        ...
                                        <tr>
                                            <td style="padding-top:8px; padding-bottom:8px; border-bottom:1px solid #E2E8F0;">
                                                <table width="100%" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        <td style="font-size:12px; color:#64748B; font-weight:500;">Workspace</td>
                                                        <td style="text-align:right; font-size:13px; font-weight:600; color:#0F172A;">{{ $workspaceName }}</td>
                                                    </tr>
                                                </table>
                                            </td>
                                        </tr>
